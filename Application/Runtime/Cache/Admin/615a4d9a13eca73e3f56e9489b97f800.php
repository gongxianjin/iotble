	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					<li>
						<i class="fa fa-dashboard"></i>  <a href="javascript:void(0)">会员管理</a>
					</li>
					<li class="active">
			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="singcms-form">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="phone" id="inputPassword2" placeholder="" value="<?php echo ($vo["phone"]); ?>">
						</div>
					</div>
					<div class="form-group">
						<label  class="col-sm-2 control-label">会员角色:</label>
						<select class="btn btn-default" name="role_id" style="margin-left: 14px;">
							<option value=''>请选择类型</option>
							<?php if(is_array($roles)): foreach($roles as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($vo["role_id"] == $v['id']): ?>selected="selected"<?php endif; ?> ><?php echo ($v["role_name"]); ?></option><?php endforeach; endif; ?>
						</select>
					</div>
...
<script>
	var SCOPE = {
		'save_url' : '/admin.php?c=member&a=save',
		'jump_url' : '',
	};
