...
<div id="wrapper">
    ...
    <?php
 $navs = D("Menu")->getAdminMenus(); $username = getLoginUsername(); $rolename = getRoleName($_SESSION['adminUser']['role_id']); foreach($navs as $k=>$v) { if($rolename == '检测员' || $rolename == '观察员') { unset($navs[$k]); } } $index = 'index'; ?>
<!-- Navigation -->
            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="singcms-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="phone" id="inputPassword2" placeholder="请填写手机号">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="btn btn-default" name="role_id" style="margin-left: 14px;">
                            <option value=''>请选择类型</option>
                            <?php if(is_array($sys)): foreach($sys as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>
                    <div class="form-group">
